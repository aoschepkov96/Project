...
10. **Открыть Anaconda Promt, написать *cd <ваш путь>* (например *cd C:\Users\User\Documents\Python Scripts\project_folder*), в котором лежат скрипты combo.py, part_1.py, part_2.py, part_3.py, ao_part_3.py, part_4.py. Далее исполнить команду *python combo.py* и следовать инструкциям внутри консоли** 
...
## Примечание
Инструкцию по переписанному 3 блоку см. в файле readme_3.md
