...
4. Данные проверены возможные ошибки в данных по разным типам переменных:
...
5. Признак age_of_car заменён на car_owned (т.е. 1 или 0).
